...
public partial class MesappContext : DbContext
{
    ...
    public virtual DbSet<TableMasterPart> TableMasterParts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=fuckingawesome;Database=MESAPP;Trusted_Connection=True;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TableMasterPart>(entity =>
        {
            entity.HasKey(e => e.MaterialId);

            entity.ToTable("Table_Master_Part");
        ...
        modelBuilder.Entity<TableMasterSerialCounter>(entity =>
        {
            ...
            entity    .ToTable("Table_Master_Serial_Counter");
        ...
        modelBuilder.Entity<TableRunTraceability>(entity =>
        {
            entity
                ...
                entity.ToTable("Table_Run_Traceability");
